...
namespace Crayon
{
	...
	enum MouseButton { NoButton, Left, Middle, Right };
	enum MouseButtonState { NoBState, Clicked, Unclicked };
	...
	public:
		MouseButtonEvent(MouseButton button, MouseButtonState state) : m_Button(button), m_ButtonState(state) { m_IsNull = false; }
